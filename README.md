...
### // WHO AM I?
I am a **Developer** based in India with a focus on creating bold, high-performance digital experiences. I bridge the gap between design and engineering, ensuring that every interaction feels polished and intentional.

- 🎓 **Student:** B.Tech Computer Science Engineering (CSE)
- 📍 **Location:** Solan, India
- ⚡ **Fun fact:** I code with `dark mode` strictly.

---

### // WHAT I'M WORKING ON
Currently, I am refining my personal portfolio to be a "brutalist" masterpiece using **HTML/CSS/JS** and **GSAP**.
...
### // MY ARSENAL (TOOLS)
I don't just write code; I craft solutions using modern standards.
